...
$setTicket = $_GET['ticket'];

$sql = "INSERT INTO reservation (name, date, ticket, amount)
VALUES ('$name', '$date', '$ticket', $amount)";
                    ...
                    <div class="hero-content contact-hero">
                        <div class="container-contact">
                            <div class="form">
                                ...
                                <form method="post">
                                    <div class="inputBx">
                                        <input type="text" name="name" required placeholder="Name" readonly value="<?php echo $user ?>">
                                    </div>
                                    <div class="inputBx">
